...
public class StewartTest6_getPersonByInvalidEmail {
    ...
    public void setup() throws Exception {
        RestUtil.setBaseURI("http://localhost:8080/getPersonByEmail/test@test.com"); // Setup Base URI
        RestUtil.setBasePath(""); // Setup Base Path, this has to have some value it cannot be null.
